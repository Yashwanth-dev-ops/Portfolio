...
export default function NotFound() {
    ...
    useEffect(() => {
        ...
        // Chatter Timeline (Mouth Animation - Simulated without MorphSVG)
        const chatterTL = gsap.timeline({ paused: true, repeat: -1, yoyo: true });
        chatterTL
            .to(['#mouthBG', '#mouthPath', '#mouthOutline'], 0.1, { scaleY: 0.8, transformOrigin: "center center" }, "0")
            .to('#chin', 0.1, { y: 1.5 }, "0");
        ...
        yetiTL
            .call(() => { chatterTL.play(); }, undefined, "0")
            ...
            .call(goLight, undefined, "3.2")
            .call(goDark, undefined, "3.3")
            .call(goLight, undefined, "3.4")

            .call(() => {
                chatterTL.pause();
                gsap.to(['#mouthBG', '#mouthPath', '#mouthOutline'], { duration: 0.1, scaleY: 1 });
            }, undefined, "3.2")

            // Surprised Look
            .to(['#mouthBG', '#mouthPath', '#mouthOutline'], 0.25, { scaleY: 0.5, scaleX: 0.8 }, "5")
            .to('#tooth1', 0.1, { y: -5 }, "5")
            .to('#armR', 0.5, { x: 10, y: 30, rotation: 10, transformOrigin: "bottom center", ease: "power2.out" }, "4")
            .to(['#eyeL', '#eyeR'], 0.25, { scaleX: 1.4, scaleY: 1.4, transformOrigin: "center center" }, "5")

            .call(goDark, undefined, "8")
            .call(goLight, undefined, "8.1")
            .call(goDark, undefined, "8.3")
            .call(goLight, undefined, "8.4")
            .call(goDark, undefined, "8.6")

            // Return to normal
            .to(['#mouthBG', '#mouthPath', '#mouthOutline'], 0.25, { scaleY: 1, scaleX: 1 }, "9")
            .to('#tooth1', 0.1, { y: 0 }, "9")
            .to('#armR', 0.5, { x: 0, y: 0, rotation: 0, transformOrigin: "bottom center", ease: "power2.out" }, "9")
            .to(['#eyeL', '#eyeR'], 0.25, { scaleX: 1, scaleY: 1, transformOrigin: "center center" }, "9")
            .call(() => { chatterTL.play(); }, undefined, "9.25")
    ...
    return (
        <div className="yeti-404-body">
            {/* Yeti SVG Structure - Copying exact SVG from request */}
            <svg id="yetiSVG" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 600 470">
                ...
                <g id="blnaket-clone-simplified">
                    {/* Simplified blanket to save space, retaining the main visuals */}
